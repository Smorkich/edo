...
public class Approval extends BaseEntity {
    ...
    @JoinTable(name = "approval_participantsapprovalblock",
    ...
    private Collection<ApprovalBlock> participantsApprovalBlocks;
     ...
     */
    @OneToMany(fetch = FetchType.LAZY)
    @JoinTable(name = "approval_signatoriesapprovalblock",
            joinColumns = @JoinColumn(name = "approval_id", referencedColumnName = "id"),
            inverseJoinColumns = @JoinColumn(name = "approvalblock_id", referencedColumnName = "id"))
    private Collection<ApprovalBlock> signatoriesApprovalBlocks;
}
