INSERT INTO address (id, full_address, street, house, "index", housing, building, city,
...
INSERT INTO department (id, short_name, full_name, address, external_id, phone, creation_date, archived_date)
VALUES (1, 'test_short_name', 'test_full_name', 1, '1', 'test_phone', '2023-05-02', '2023-05-02')
ON CONFLICT (id) DO NOTHING;


INSERT INTO employee(id, first_name, last_name, middle_name, fio_dative, fio_nominative,
