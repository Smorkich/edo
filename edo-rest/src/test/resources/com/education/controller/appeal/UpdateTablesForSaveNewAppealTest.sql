--добавление employee
INSERT INTO employee (id, first_name, last_name, middle_name, fio_dative, fio_nominative, fio_genitive, external_id,
...
--добавление region
INSERT INTO region (external_id, name_subject_rf, archiving_date, quantity, federal_district_id, primary_branches,
                        local_branches)
VALUES (DEFAULT, null, null, null, null, null, null);

--добавление FilePool
INSERT INTO file_pool (id, storage_file_id, name, extension, size, page_count, upload_date, archived_date,
                           creator_id)
